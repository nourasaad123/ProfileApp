package com.example.myappwithroomdatabase.domain

import com.example.myappwithroomdatabase.screens.deleteProfileFromDatabase
import com.example.myappwithroomdatabase.screens.getProfileFromDatabase
import com.example.myappwithroomdatabase.screens.updateProfileInDatabase
...
fun DetailsScreen(
    ...
    Column(
        ...
        Spacer(modifier = Modifier.height(16.dp))
        OutlinedTextField(value = updatedName, onValueChange = { updatedName = it },
            label = { Text(" Name") }
        )
        OutlinedTextField(value = updatedAge, onValueChange = { updatedAge = it },
            label = { Text(" Age") }
        )
        Spacer(modifier = Modifier.height(16.dp))
        Row(
